        ...
        if self.clicked == True and self.trial < N_TRIALS:
            ...
            if self.cont >= INTERSTIMULUS and self.cont < INTERSTIMULUS+PRESENTATION_TIME:
                ...
                if self.sequence[self.trial] == 1:
                    self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaE.jpg") # todos esquerda
                if self.sequence[self.trial] == 2:
                    self.img (win,  WIDTH*.05, HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaED.jpg") # laterais esquerda
                if self.sequence[self.trial] == 3:
                    self.img (win,  WIDTH*.05, HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaD.jpg")# todos para direita
                if self.sequence[self.trial] == 4:
                    self.img (win,  WIDTH*.05, HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaDE.jpg")# laterais para direita
                
                if self.sequence[self.trial] == 5:
                    self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulE.jpg") # all left
                if self.sequence[self.trial] == 6:
                    self.img (win,  WIDTH*.05, HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulDE.jpg") # center left
                if self.sequence[self.trial] == 7:
                    self.img (win,  WIDTH*.05, HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulD.jpg")# all right
                if self.sequence[self.trial] == 8:
                    self.img (win,  WIDTH*.05, HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulED.jpg")# center right                           
            ...
            if self.cont >= INTERSTIMULUS+PRESENTATION_TIME and self.cont < INTERSTIMULUS+PRESENTATION_TIME+FEEDBACK:
                ...
                if self.sequence[self.trial] == 1 and (np.array(self.key) == 0).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.5, "img/rosaFelizE.jpg")
                elif self.sequence[self.trial] == 1 and (np.array(self.key) == 1).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.5, "img/rosaTristeE.jpg")
                	
                if self.sequence[self.trial] == 2 and (np.array(self.key) == 0).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaFelizED.jpg")
                elif self.sequence[self.trial] == 2 and (np.array(self.key) == 1).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaTristeED.jpg")
                
                if self.sequence[self.trial] == 3 and (np.array(self.key) == 1).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaFelizD.jpg")
                elif self.sequence[self.trial] == 3 and (np.array(self.key) == 0).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaTristeD.jpg")
                	
                if self.sequence[self.trial] == 4 and (np.array(self.key) == 1).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaFelizDE.jpg")
                elif self.sequence[self.trial] == 4 and (np.array(self.key) == 0).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/rosaTristeDE.jpg")
                
                if self.sequence[self.trial] == 5 and (np.array(self.key) == 0).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulFelizE.jpg")
                elif self.sequence[self.trial] == 5 and (np.array(self.key) == 1).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulTristeE.jpg")
                	
                if self.sequence[self.trial] == 6 and (np.array(self.key) == 0).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulFelizDE.jpg")
                elif self.sequence[self.trial] == 6 and (np.array(self.key) == 1).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulTristeDE.jpg")
                	
                if self.sequence[self.trial] == 7 and (np.array(self.key) == 1).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulFelizD.jpg")
                elif self.sequence[self.trial] == 7 and (np.array(self.key) == 0).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulTristeD.jpg")
                	
                if self.sequence[self.trial] == 8 and (np.array(self.key) == 1).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulFelizED.jpg")
                elif self.sequence[self.trial] == 8 and (np.array(self.key) == 0).any():
                	self.img (win,  WIDTH*.05,HEIGHT*.23, WIDTH*.25,HEIGHT*1.50, "img/azulFelizED.jpg")               
