        ...
        if self.clicked == True and self.trial < N_TRIALS:
            ...
            if self.cont >= INTERSTIMULUS and self.cont < INTERSTIMULUS+PRESENTATION_TIME:
                ...
                if self.sequence[self.trial] == 1:
                    self.img (win,  WIDTH*.13, (HEIGHT//2)-(WIDTH*.05), WIDTH*.10, "img/dots_stripes.png") #dots stripes left
                if self.sequence[self.trial] == 2:
                    self.img (win,  WIDTH*.13, (HEIGHT//2)-(WIDTH*.05), WIDTH*.10, "img/dots_solid.png") #dots solid left
                if self.sequence[self.trial] == 3:
                    self.img (win,  WIDTH*.77, (HEIGHT//2)-(WIDTH*.05), WIDTH*.10, "img/dots_stripes.png")# dots stripes right
