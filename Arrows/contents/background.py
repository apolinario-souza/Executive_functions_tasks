        ...
        if self.clicked == True and self.trial < N_TRIALS:
            ...
            if self.cont >= INTERSTIMULUS and self.cont < INTERSTIMULUS+PRESENTATION_TIME:
                ...
                if self.sequence[self.trial] == 1:
                    self.img (win,  WIDTH*.13, (HEIGHT//2)-(WIDTH*.05), WIDTH*.10, "img/down.png") #arrow down left
                if self.sequence[self.trial] == 2:
                    self.img (win,  WIDTH*.13, (HEIGHT//2)-(WIDTH*.05), WIDTH*.10, "img/downRight.png") # 45 angle left
                if self.sequence[self.trial] == 3:
                    self.img (win,  WIDTH*.77, (HEIGHT//2)-(WIDTH*.05), WIDTH*.10, "img/down.png")# arrow down right
                if self.sequence[self.trial] == 4:
                    self.img (win,  WIDTH*.77, (HEIGHT//2)-(WIDTH*.05), WIDTH*.10, "img/downLeft.png")# 45 angle right                           
